Copy-Item -Path "\\app-server\APPS\_Intune Applications\1 Source\PowerShell\SafeSenders\Device script to append safe sender domain instead of overwrite\junkmailimportlistsAppendValueToOneDetection.txt" -Destination "C:\Support\SafeSenders\junkmailimportlistsAppendValueToOneDetection.txt" -Force
